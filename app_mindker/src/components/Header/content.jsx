        ...
        <Flex align="center">
          <Heading as="cite" ml={100} w="100%">
            <Text>
              ...
              común:aprender**.** Esta app consiste en un juego de tarjetas que se agrupan
              en mazos según la temática. Gracias a ellas se trabaja sobre la curva del
              olvido, detallada más abajo. Hay dos tipos de usuarios. Por un lado el
              invitado, que podrá disfrutar de una pequeña demo en la cuál probar la
              aplicación de forma limitada, es decir, jugar con los mazos de tarjetas que
              ya existen por defecto. Por otro lado, tenemos al usuario registrado, quien
              disfrutará de todos los beneficios del juego: crear mazos que contengan
              tarjetas personalizadas o compartirlos con otros usuarios, entre otras
              ventajas. Aclarar que cada tarjeta formula una pregunta ofreciendo una
