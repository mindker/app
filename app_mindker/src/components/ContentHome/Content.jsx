        ...
        <Flex align="center">
          <Heading as="cite" ml={100} w="100%">
            <Text>
              ...
              theme. Thanks to them, we work on the curve of oblivion. Each card asks a
              question offering an answer that the user must remember. In relation to the
              difficulty that the user encounters when remembering the answer, the cards
              are repeated more or less frequently. This methodology is based on the
              subjectivity of the user about his own learning, since he himself is the one
              who determines the degree of difficulty he has experienced when remembering
