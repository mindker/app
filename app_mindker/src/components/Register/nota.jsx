...
data.append('upload_preset', 'ml_default'); // El nombre debe ser el mismo que el que se creo en Cloudinary
data.append('cloud_name', 'drprserzu-name');